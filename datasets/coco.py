...
def build(image_set, args):
    ...
    mode = 'instances'
    # print(f"\033[31m{root}\033[0m")
    if args.dataset_file == 'visdrone':
        PATHS = {
            "train": (root / "VisDrone2019-DET-train/images", root / "VisDrone2019-DET-train/annotations_VisDrone_train.json"),
            "trainval": (root / "VisDrone2019-DET-val/images", root / "VisDrone2019-DET-val/annotations_VisDrone_val.json"),
            "val": (root / "VisDrone2019-DET-val/images", root / "VisDrone2019-DET-val/annotations_VisDrone_val.json"),
            "eval_debug": (root / "images/val", root / "annotations" / 'aitodv2_val.json'),
            "test": (root / "images/test", root / "annotations" / 'aitodv2_test.json' ),
        }
    elif args.dataset_file == 'UAVDT':
        PATHS = {
            "train": (root / "images", root / "annotations_train.json"),
            "trainval": (root / "images", root / "annotations_val.json"),
            "val": (root / "images", root / "annotations_val.json"),
            "eval_debug": (root / "images/val", root / "annotations" / 'aitodv2_val.json'),
            "test": (root / "images/test", root / "annotations" / 'aitodv2_test.json' ),
        }
